...
const managedPages = [
  [
    "users",
    "Users",
    "Edit account data, roles, access, restrictions, and moderation context.",
    "users",
  ],
  [
    "servers",
    "Servers",
    "Edit listings, verification, ownership, moderation, and connection health.",
    "servers",
  ],
  [
    "reports",
    "Reports",
    "Review safety, campaign, server, user, and community reports.",
    "reports",
  ],
  [
    "ownership",
    "Ownership Verification",
    "Review evidence and manage verified server ownership.",
    "ownership",
  ],
  [
    "milestones",
    "Milestone Templates",
    "Edit allowed tasks, verification methods, and Sparks limits.",
    "milestones",
  ],
  [
    "participations",
    "Participations",
    "Inspect campaign history and current verification states.",
    "participations",
  ],
  [
    "disputes",
    "Completion Disputes",
    "Review evidence, timelines, configuration snapshots, and appeals.",
    "disputes",
  ],
  [
    "fraud",
    "Risk Signals",
    "Route proportionate signals to human review and document outcomes.",
    "fraud",
  ],
  [
    "reviews",
    "Reviews",
    "Moderate public server reviews separately from private feedback.",
    "reviews",
  ],
  [
    "feature-flags",
    "Feature Flags",
    "Control rollout for integrations and product capabilities.",
    "flags",
  ],
  [
    "settings",
    "System Settings",
    "Manage restricted thresholds, adapters, policies, and platform defaults.",
    "settings",
  ],
] as const;
      ...
      <Routes>
        ...
        <Route
          ...
          element={
            <AdminGenericPage
              ...
              description="Send moderated service messages to players, owners, or selected accounts."
              type="messages"
            />
          }
        />
        <Route
          ...
          element={
            <AdminGenericPage
              ...
              description="Manage roles, capabilities, and privileged access."
              type="access"
            />
          }
        />
        <Route
          ...
          element={
            <AdminGenericPage
              ...
              description="Inspect live product and moderation activity."
              type="monitor"
            />
          }
        />
        <Route
          ...
          element={
            <AdminGenericPage
              ...
              description="Understand website usage and campaign conversion."
              type="analytics"
            />
          }
        />
        <Route
          ...
          element={
            <AdminGenericPage
              title="Umami"
              description="Configure privacy-conscious site usage analytics."
              type="umami"
            />
          }
        />
        <Route
          ...
          element={
            <AdminGenericPage
              title="Audit Logs"
              description="Review append-only records for important administrative actions."
              type="audit"
            />
          }
        />
        <Route
          ...
          element={
            <AdminGenericPage
              title="Termination Console"
              description="Restrict or terminate users and servers with safeguards and audit trails."
              type="termination"
            />
          }
        />
        <Route
          ...
          element={
            <AdminGenericPage
              title="Sparks Ledger"
              description="Inspect Sparks eligibility, adjustments, limits, and verification history."
              type="ledger"
            />
          }
        />
        {managedPages.map(([path, title, description, type]) => (
          <Route
            key={path}
            path={path}
            element={<AdminGenericPage title={title} description={description} type={type} />}
          />
        ))}
      </Routes>
    </AdminLayout>
