...
4. The backend sums the referred user's credited Sparks ledger entries. Debits do not reduce earned
   progress. At 200 credited Sparks, the invite is atomically marked qualified.
